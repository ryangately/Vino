...
public class ViNoDebug {
	...
	public ViNoDebug() throws IOException {
		...
		story.addBackground("images/spacebg.png");
		story.addActor("images/character.png");
		story.addExplorationObject("images/smallbook.png");
		...
		logicEight.setComparison(0, true);
