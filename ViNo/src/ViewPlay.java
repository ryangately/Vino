...
public class ViewPlay {
	...
	private BufferedImage textPaneImage;
	...
	private BufferedImage nextArrowImage;
	...
	public ViewPlay(String title) throws IOException {
		...
		*/
		...
		textPaneImage = ImageIO.read(new File("images/panel.png"));
		textPaneIcon = new ImageIcon(textPaneImage);
		...
		nextArrowIcon = new ImageIcon(nextArrowImage);
	...
	public void setBackground(BufferedImage background) {
		bgImageIcon = new ImageIcon(background);
		bgLabel.setIcon(bgImageIcon);
	}
	
	public void setLeftActor(BufferedImage leftActor) {
		if (leftActor == null) {
			leftActorLabel.setVisible(false);
			return;
		}
		leftActorIcon = new ImageIcon(leftActor);
		leftActorLabel.setIcon(leftActorIcon);
	...
	public void setRightActor(BufferedImage rightActor) {
		rightActorIcon = new ImageIcon(rightActor);
		rightActorLabel.setIcon(rightActorIcon);
		rightActorLabel.setBounds(50, 720 - rightActorIcon.getIconHeight(), rightActorIcon.getIconWidth(), rightActorIcon.getIconHeight());
	}
	
	public void setMidActor(BufferedImage midActor) {
		midActorIcon = new ImageIcon(midActor);
		midActorLabel.setIcon(midActorIcon);
		midActorLabel.setBounds(50, 720 - midActorIcon.getIconHeight(), midActorIcon.getIconWidth(), midActorIcon.getIconHeight());
	}
	...
	public void setExplorationIcon(int num, int x, int y, BufferedImage img) {
		if (num == 0) {
			ImageIcon explorationIcon = new ImageIcon(img);
